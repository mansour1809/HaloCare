...
const KidFlowerProfile = ({ kid }) => {
  ...
  const handleCategoryClick = (category) => {
    navigate(`/kids/${kid.kidId}/treatments/${category.name}`);
  };
  ...
  const renderFlower5 = () => (
    <svg width="100%" height="100%" viewBox="0 0 698 681" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* כאן יש להעתיק את התוכן של ה-SVG עם 5 עלים */}
      {/* עלה 1 */}
      <g filter="url(#filter0_d_2144_1444)">
        <path
          ...
          fill={hoveredPetal === "petal1" ? "#d8c5ec" : "#c6b1e2"}
          style={{ 
          ...
          onClick={() => onCategoryClick(treatmentCategories[0])}
        />
      </g>
      ...
      <g filter="url(#filter0_d_2144_1444)">
              <path 
                ...
                fill={hoveredPetal === "petal2" ? "#f7c29b" : "#f4b183"}
                style={{ 
                  transition: 'all 0.3s ease',
                ...
                onMouseLeave={() => handlePetalHover(null)}
                onClick={() => handleCategoryClick(treatmentCategories[1])}
              />
            </g>
            <g filter="url(#filter0_d_2144_1444)">
            <path 
                ...
                onMouseLeave={() => handlePetalHover(null)}
                onClick={() => handleCategoryClick(treatmentCategories[2])}
              />
            </g>
            <g filter="url(#filter0_d_2144_1444)">
              <path 
                ...
                fill={hoveredPetal === "petal4" ? "#ffb3b3" : "#ff9f9f"}
                style={{ 
                  transition: 'all 0.3s ease',
                ...
                onMouseLeave={() => handlePetalHover(null)}
                onClick={() => handleCategoryClick(treatmentCategories[3])}
              />
            </g>
            ...
            <g filter="url(#filter0_d_2144_1444)">
              <path 
                ...
                fill={hoveredPetal === "petal5" ? "#a0dccf" : "#8fd3c3"}
                style={{ 
                  transition: 'all 0.3s ease',
                ...
                onMouseLeave={() => handlePetalHover(null)}
                onClick={() => handleCategoryClick(treatmentCategories[4])}
              />
            </g>
      {/* המעגל המרכזי */}
      <circle cx="350" cy="330" r="80" fill="white" stroke="#ccc" strokeWidth="2" />
      ...
      <g filter="url(#filter0_d_2144_1444)">
            ...
            <g id="Group_6" data-name="Group 6">
              <path 
                ...
                fill={hoveredPetal === "petal6" ? "#91d3e1" : "#7ac7d7"}
                style={{ 
                  transition: 'all 0.3s ease',
                ...
                onMouseLeave={() => handlePetalHover(null)}
                onClick={() => handleCategoryClick(treatmentCategories[5])}
              />
            </g>
            <path 
          id="petal7" 
  ...
  const getPositions = () => {
    if (treatmentTypes.length <= 5) {
      return [
        { textPos: { top: '25%', left: '22%' }, buttonPos: { top: '32%', left: '22%' } }, // עלה 1
        { textPos: { top: '60%', left: '22%' }, buttonPos: { top: '67%', left: '22%' } }, // עלה 2
        { textPos: { top: '80%', left: '50%' }, buttonPos: { top: '87%', left: '50%' } }, // עלה 3
        { textPos: { top: '60%', left: '78%' }, buttonPos: { top: '67%', left: '78%' } }, // עלה 4
        { textPos: { top: '25%', left: '78%' }, buttonPos: { top: '32%', left: '78%' } }, // עלה 5
      ];
    } else {
      return [
        { textPos: { top: '20%', left: '45%' }, buttonPos: { top: '28%', left: '45%' } }, // עלה 1
        { textPos: { top: '48%', left: '20%' }, buttonPos: { top: '55%', left: '20%' } }, // עלה 2
        { textPos: { top: '75%', left: '45%' }, buttonPos: { top: '83%', left: '45%' } }, // עלה 3
        { textPos: { top: '75%', left: '75%' }, buttonPos: { top: '83%', left: '75%' } }, // עלה 4
        { textPos: { top: '48%', left: '82%' }, buttonPos: { top: '55%', left: '82%' } }, // עלה 5
        { textPos: { top: '20%', left: '75%' }, buttonPos: { top: '28%', left: '75%' } }  // עלה 6
      ];
    }
  };
  ...
  return (
    <Box sx={{ position: 'relative', width: '100%', maxWidth: '640px', margin: '0 auto' }}>
      ...
      >
        <img 
          src={kid?.photo ? `https://localhost:7225/api/Documents/content-by-path?path=${encodeURIComponent(kid.photo)}` : "https://via.placeholder.com/120"}
