...
const LogoArea = styled(Box)(({ theme }) => ({
  ...
  width: '150px',
  height: '134px',
  marginBottom: '-30px', // שלילי כדי לגרום ללוגו לחפוף עם הטופס
  zIndex: 2, // מעל הטופס
}));
...
const ProgressLogo = ({ 
  ...
  // חישוב האחוז שהושלם
  const progress = Math.round((activeStep / (totalSteps-1)) * 100);
  
  // רשימת השלבים אם לא סופקה
  const defaultSteps = [
    'פרטים אישיים',
    'רקע התפתחותי',
    'מידע רפואי',
