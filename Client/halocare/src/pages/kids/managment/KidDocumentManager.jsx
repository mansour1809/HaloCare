...
const KidDocumentManager = ({ 
  ...
  if (compact) {
    return (
      <CompactContainer 
        ...
        maxHeight={maxHeight}
      >
        {/* Title functionality, updated styling */}
        ...
        {/* Stats functionality, updated styling */}
        {showStats && expanded && (
        ...
        {/* Upload button functionality, updated styling */}
        {showUpload && expanded && (
        ...
        {/* Upload Dialog functionality, updated styling */}
        <Dialog 
          open={uploadDialog} 
  ...
  // Main mode functionality with updated styling
  return (
    <ModernContainer sx={{ maxHeight }}>
      <Box sx={{ p: 0 }}>
        {/* Header functionality, updated styling */}
        <Box sx={{ 
          p: 3, 
          ...
          {/* Statistics functionality, updated styling */}
          {showStats && (
        ...
        {/* Loading state functionality, updated styling */}
        {documentsStatus === 'loading' && (
          <Box sx={{ 
            display: 'flex', 
        ...
        {/* Content functionality, updated styling */}
        {documentsStatus !== 'loading' && (
          <>
            {/* Tabs functionality, updated styling */}
            <StyledTabs
              value={currentTab}
            ...
            <Box sx={{ p: 3 }}>
              ...
              {/* Empty state functionality, updated styling */}
