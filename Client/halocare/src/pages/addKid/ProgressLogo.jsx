...
// מעטפת ה-SVG עם גלישה מוסתרת לחיתוך
...
const LogoFill = styled('svg')(({ progress, theme }) => ({
  ...
  height: '100%',
  zIndex: 2,
  clipPath: `inset(${100 - progress}% 0 0 0)`, // חיתוך מלמעלה כלפי מטה - ככל שהאחוז גדל, החיתוך יורד
  transition: 'clip-path 0.8s ease-in-out',
}));

// שלבי התהליך מתחת ללוגו
const StepsContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
  justifyContent: 'center',
  marginTop: theme.spacing(1),
  marginBottom: theme.spacing(3),
  flexWrap: 'wrap', // אם יש הרבה שלבים, הם ירדו לשורה הבאה
}));

const Step = styled(Box)(({ active, completed, theme }) => ({
...
const ProgressLogo = ({ 
  ...
  return (
    <Box sx={{ textAlign: 'center', mb: 4 }}>
      ...
      {kidName && <KidName variant="h6">{kidName}</KidName>}
